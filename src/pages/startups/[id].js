        ...
        <>
            ...
            <main>
                <section className="postList">
                    ...
                    <h4 className="supportMoney">
                        <span className="moneyBold">Підтримати автора за:</span>
                        <br />
                        {data.payments}
                    </h4>
                    <h4 className="contactAuthor">
                        <span className="moneyBold">
                            Зв’язатися з автором за:
                        </span>
                        <br />
                        {data.socials}
                    </h4>
...
export async function getServerSideProps(context) {
    const res = await fetch(
        `http://localhost:3000/api/startups/${context.params.id}`
    );
