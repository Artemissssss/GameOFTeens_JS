...
export default function Profile({ data }) {
    ...
    return (
        <>
            ...
            <div className="startupsBlock">
                <main>
                    <section className="postList">
                        <h2 className="startupsListPage">
                            Проєкти для івестицій
                        </h2>
                        <div className="filterBtn">
                            <button
                                className="filterBtnPop"
                                onClick={() => {
                                    setFilter(true);
                                }}
                            >
                                <span className="filterBtnText">Популярні</span>
                            </button>
                            <button
                                className="filterBtnNew"
                                onClick={() => {
                                    setFilter(false);
                                }}
                            >
                                <span className="filterBtnText">Нові</span>
                            </button>
                        </div>
                                      ...
                                      .map((arr, i) => {
                                          return (
                                              ...
                                              >
                                                  ...
                                                  <button className="stertupsItemBtn">
                                                      <Link
                                                          href={`/startups/${arr._id}`}
                                                          className="stertupsItemA"
                                                      >
                                                          Подивитися більше
                                                      </Link>
                                                  </button>
