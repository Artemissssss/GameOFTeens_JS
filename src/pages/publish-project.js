                ...
                <div className="adminSectWrap">
                    <div className="adminArtilesFunc">
                        <form className="addArticles" onSubmit={addarticle}>
                            ...
                            <textarea
                                className="commentFromText"
                                onChange={(e) => {
                                    paymentsSet(e.target.value);
                                }}
                                name="text"
                                placeholder="Де можна підтримати фінансово (PayPal, номер карти, реквізити тощо)"
                                maxLength="500"
                            ></textarea>
                            <textarea
                                className="commentFromText"
                                onChange={(e) => {
                                    socialsSet(e.target.value);
                                }}
                                name="text"
                                placeholder="Контактна інормація(номер телефону, gmail, telegram тощо)"
                                required
                                maxLength="500"
                            ></textarea>
                            <ReCAPTCHA
                                ...
                                ref={captch}
                            />
                            <button className="commentFromBtn">
                                <span className="commentFromBtnText">
                                    Опублікувати
                                </span>
                            </button>
                        </form>
